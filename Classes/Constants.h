...
static const int CONTACT_MASK_PLAYER = CATEGORY_MASK_WALL | CATEGORY_MASK_BULLET;
static const int CONTACT_MASK_WALL = CATEGORY_MASK_PLAYER | CATEGORY_MASK_BULLET;
static const int CONTACT_MASK_BULLET = CATEGORY_MASK_WALL | CATEGORY_MASK_BULLET;
